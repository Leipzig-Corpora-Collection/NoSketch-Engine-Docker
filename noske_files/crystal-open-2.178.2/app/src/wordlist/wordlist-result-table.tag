<wordlist-result-table class="wordlist-result-table">
    <div if={!data.isEmpty && !data.isEmptySearch}
            class={oneColumn: data.onecolumn || store.areTimelinesDisplayed()}>
        <column-table ref="table"
            ...
            on-sort={onSort}
            max-column-count={data.onecolumn || store.areTimelinesDisplayed() ? 1 : 0}
    ...
    <script>
        ...
        addMenuColumn(){
            this.colMeta.push({
                ...
                generator: (item, cm) => {
                    let ret = ""
                    if(this.store.areTimelinesDisplayed()){
        ...
        addTimelineColumn(){
            this.store.areTimelinesDisplayed() && this.colMeta.push({
                id:"chart",
